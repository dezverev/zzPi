...
const PARENT_PROMPT = [
  ...
  "Keep brainstorming and design separate from implementation. When implementation is requested, continue through normal parent-agent work and use implementationsubagent for parent-decomposed bounded pieces when useful.",
  "</design_loop>",
].join("\n");
