...
const PARENT_PROMPT = [
  ...
  "Keep brainstorming and design separate from implementation. When implementation is requested, continue through normal parent-agent work and use implementationsubagent only for parent-decomposed medium-to-small independently vettable pieces, returning to the main thread for review and course correction after each piece.",
  "</design_loop>",
].join("\n");
